...
class GetDataSet(object):
    ...
    def mnistDataSetConstruct(self, isIID):
        ...
        # 修改
        self.train_set = torchvision.datasets.MNIST(root=os.path.dirname(os.path.abspath(__file__))+"/data", train=True, transform=data_tf, download=False)
        self.test_set = torchvision.datasets.MNIST(root=os.path.dirname(os.path.abspath(__file__))+"/data", train=False, transform=data_tf, download=False)
...
if __name__=="__main__":
    'test1 data set'
    mnistDataSet = GetDataSet('mnist', True) # test1 NON-IID
    # 下面是原代码
    ...
    # print('the shape of the test1 data set is {}'.format(mnistDataSet.test_data.shape))
